...
public class DataCacheManager {
    ...
    private static final String TAG = com.netease.nim.uikit.cache.DataCacheManager.class.getSimpleName();

    /**
     * App初始化时向SDK注册数据变更观察者
     */
    public static void observeSDKDataChanged(boolean register) {
        com.netease.nim.uikit.cache.FriendDataCache.getInstance().registerObservers(register);
    ...
    public static void buildDataCache() {
        ...
        com.netease.nim.uikit.cache.FriendDataCache.getInstance().buildCache();
