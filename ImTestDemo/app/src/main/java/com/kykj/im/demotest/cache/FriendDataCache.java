...
public class FriendDataCache {
    ...
    public static com.netease.nim.uikit.cache.FriendDataCache getInstance() {
    ...
    static class InstanceHolder {
        final static com.netease.nim.uikit.cache.FriendDataCache instance = new com.netease.nim.uikit.cache.FriendDataCache();
    }
}
